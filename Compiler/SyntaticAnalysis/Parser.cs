...
namespace Compiler.SyntacticAnalysis
{
    ...
    public class Parser
    {
        ...
        private ICommandNode ParseForCommand()
        {
            ...
            Accept(To);
            IExpressionNode expressionTo = ParseBinaryExpression();
            Accept(Do);
            ICommandNode command = ParseCommand();
            Accept(Next);
            return new ForCommandNode(identifier,expression, expressionTo, command, position);
        }
        ...
        private IDeclarationNode ParseVarDeclaration()
        {
            ...
            IdentifierNode identifier = ParseIdentifier();
            Accept(Colon);
            TypeDenoterNode typeDenoter = ParseTypeName();
        ...
        private TypeDenoterNode ParseTypeName()
        {
